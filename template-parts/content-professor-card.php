    ...
    <div class="professor-info-section p-6">
        ...
        <div class="text-center mb-4">
            <h3 class="text-xl font-bold text-gray-800">
                <?php echo esc_html($professor['name']); ?><?php echo esc_html($professor['position']); ?>
            </h3>
        </div>
        
        <!-- 担当 -->
        <?php if ( $professor['responsibility'] ) : ?>
            <div class="mb-3">
