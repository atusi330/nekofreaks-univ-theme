...
function nfu_get_professors() {
    ...
    foreach ($professors as $professor) {
        $professor_data[] = array(
            ...
            'description' => get_field('professor_description', $professor->ID),
            'position' => get_field('professor_position', $professor->ID),
            'age' => get_field('professor_age', $professor->ID),
            'gender' => get_field('professor_gender', $professor->ID),
            'breed' => get_field('professor_breed', $professor->ID),
            'specialty' => get_field('professor_specialty', $professor->ID),
            'color' => get_field('professor_color', $professor->ID),
